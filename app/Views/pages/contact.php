...
<section
    style="
        background-image:url('<?= e(asset_url('assets/images/banner-services-materials-clean.png')) ?>');
...
<section>
        ...
        <div class="space-y-5">
            ...
            <div class="rounded-lg border border-slate-200 bg-slate-50 p-6">
                ...
                <dl class="mt-5 space-y-4 text-sm leading-6">
                    <div>
                        <dt class="font-bold text-slate-950">Phone</dt>
                        <dd>
                            <a class="text-red-600" href="tel:+919766653376">
                                <?= e($company['phone']) ?>
                            </a>
                        </dd>
                    </div>
                    ...
                    <div>
                        <dt class="font-bold text-slate-950">WhatsApp</dt>
                        <dd>
                            <a class="text-red-600"
                               href="https://wa.me/<?= e($company['whatsapp']) ?>"
                               target="_blank"
                               rel="noopener">
                                Message Digi CNC on WhatsApp
                            </a>
                        </dd>
                    </div>

                    <div>
                        <dt class="font-bold text-slate-950">Location</dt>
                        <dd><?= e($company['location']) ?></dd>
                    </div>

                    <div>
                        <dt class="font-bold text-slate-950">Business Hours</dt>
                        <dd><?= e($company['hours']) ?></dd>
                    </div>
                </dl>

                <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                    <a class="btn-primary flex-1 justify-center py-3"
                       href="tel:+919766653376">
                        Call Now
                    </a>

                    <a class="btn-secondary flex-1 justify-center border-slate-300 py-3 text-slate-950"
                       href="https://wa.me/<?= e($company['whatsapp']) ?>"
                       target="_blank"
                       rel="noopener">
                        WhatsApp
    ...
    <li class="flex gap-3">
        ...
        <span>Send CAD files such as DXF, DWG, SVG, AI, CDR or clean PDF references when available.</span>
    </li>

    <li class="flex gap-3">
        <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-red-600"></span>
        <span>Mention material, thickness, sheet size, quantity, finish expectation and deadline.</span>
    </li>

    <li class="flex gap-3">
        <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-red-600"></span>
        <span>For jali and parametric work, include final panel size and installation context.</span>
    </li>

    <li class="flex gap-3">
        <span class="mt-2 h-2 w-2 shrink-0 rounded-full bg-red-600"></span>
        <span>For furniture components, include part labels, hardware references and batch quantity.</span>
    </li>
</ul>
            </div>
    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-6">
        <div class="mt-12 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
            <iframe
...
<section class="bg-slate-50 py-4">
    <div class="mx-auto mt-4 grid max-w-7xl gap-6 px-4 lg:grid-cols-[1fr_.9fr] lg:px-6">
  ...
  <div class="rounded-lg border-4 border-red-500 bg-white p-6 shadow-sm">
            <h2 class="font-heading text-2xl text-center font-bold">Contact FAQs</h2>
            <div class="mt-5 divide-y divide-slate-200">
                <?php foreach ($repo->faqs('contact') as $faq): ?>
                    <details class="faq-item py-5 px-5 my-auto">
