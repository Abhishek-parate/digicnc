...
<body class="bg-white text-slate-900 antialiased">
    ...
    <header class="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 shadow-sm backdrop-blur">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-6">
            <a href="<?= e(app_url('')) ?>" class="group flex items-center gap-2" aria-label="Digi CNC home">
                <img src="<?= e(asset_url('assets/images/logo1.png.png')) ?>" alt="Digi CNC Logo" class="h-16 w-auto max-w-[200px] object-contain">
        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4 lg:px-6">
            <div>
                <div class="flex items-center gap-3">
                    <img src="<?= e(asset_url('assets/images/logo2.png.png')) ?>" alt="Digi CNC Logo" class="h-16 w-auto object-contain" style="filter: brightness(0) invert(1);">
                </div>
