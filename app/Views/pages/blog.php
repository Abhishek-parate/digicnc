<section class="inner-hero">
    <div class="mx-auto max-w-7xl px-4 py-20 lg:px-6">
        ...
        <h1 class="mt-4 max-w-4xl font-heading text-4xl font-extrabold leading-tight text-white lg:text-6xl">CNC Cutting, Materials, Design and Manufacturing Blog</h1>
        <p class="mt-6 max-w-3xl text-lg leading-8 text-slate-200">Practical articles for architects, interior designers, furniture manufacturers, contractors, homeowners and prototype teams planning CNC cutting or carving projects in Nagpur.</p>
    </div>
</section>
